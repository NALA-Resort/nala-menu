...
/* Initials, for a board where the space is a tile. Two letters from two words,
   one from a single name: a made up second initial would be somebody else's.
   Falls back to nothing rather than to a guess, and the caller drops the
   whole phrase when there is nothing to show. */
