...
function overlayStays(roomguests, stays){
  ...
  for (var villa in (stays || {})){
    ...
    if (rec) out[String(villa)] = Object.assign({}, out[String(villa)] || {}, rec);
  }
  return out;
}
